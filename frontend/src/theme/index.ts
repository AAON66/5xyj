...
export function buildTheme(mode: 'light' | 'dark'): ThemeConfig {
  ...
  return {
    ...
    components: {
      Layout: {
        siderBg: '#1F2329', // D-16 Sider stays dark in both modes
        headerBg: isDark ? '#1F1F1F' : '#FFFFFF',
        bodyBg: isDark ? '#1F1F1F' : '#F5F6F7', // Pitfall 5: slightly lighter than default #141414 to distinguish from Sider
        headerHeight: 56,
      ...
      Table: {
        headerBg: isDark ? undefined : '#F5F6F7',
        headerColor: isDark ? undefined : '#1F2329',
        rowHoverBg: isDark ? undefined : '#F0F5FF', // D-18 dark mode defers to darkAlgorithm

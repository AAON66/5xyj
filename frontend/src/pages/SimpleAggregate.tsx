...
import { runSimpleAggregate, type AggregateArtifact, type AggregateRunResult } from '../services/aggregate';
...
export function SimpleAggregatePage() {
  ...
  async function handleRun() {
    ...
    try {
      const payload = await runSimpleAggregate({
        files: socialFiles,
        employeeMasterFile,
        batchName,
      });
    ...
    >
      ...
      <div className="panel-grid panel-grid--two simple-aggregate-grid">
        ...
        <section className="panel-card simple-aggregate-card">
          ...
          {running ? (
            <SectionState title="\u6b63\u5728\u6267\u884c\u5feb\u901f\u805a\u5408" message="\u7cfb\u7edf\u6b63\u5728\u81ea\u52a8\u5b8c\u6210\u89e3\u6790\u3001\u6821\u9a8c\u3001\u5339\u914d\u4e0e\u53cc\u6a21\u677f\u5bfc\u51fa\u3002" />
          ) : result ? (
